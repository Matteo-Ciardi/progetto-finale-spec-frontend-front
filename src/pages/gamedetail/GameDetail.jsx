    ...
    <>
      <div className="gamedetail-container">
        ...
        <div className="gamedetail-right">
          <h2>Informazioni</h2>
          <p>
            <b>Categoria:</b> {game.category}
          </p>
          <p>
            <b>Prezzo:</b> €{game.price}
          </p>
          <p>
            <b>Rating:</b> {game.rating}
          </p>
          <p>
            <b>Anno di uscita:</b> {game.releaseYear}
          </p>
          <p>
          ...
          <button onClick={addToCompare}>COMPARA</button>
        </div>
      </div>

      {compareList.length > 0 && (
        <Comparator games={compareList} availableGames={games} />
      )}
    </>
  );
}
